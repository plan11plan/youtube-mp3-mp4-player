...
//
//   MusicListItem({required this.mediaFile, required this.isLiked});
//
//   @override
...
//             ],
//           ),
//           Row(  // New row containing like icon and navigation icon
//             children: [
//               Icon(
//                 Icons.favorite,
//                 color: mediaFile.like ? Colors.red : Colors.grey,  // Change color based on like status
//               ),
//               IconButton(
