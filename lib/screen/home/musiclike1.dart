                              ...
                              itemBuilder: (context, index) {
                                return Column(
                                  children: [
                                    ...
                                    if (index != mediaFiles.length - 1)  // 마지막 항목이 아닌 경우에만 그림자를 가진 Container 추가
                                      Container(
                                        width: MediaQuery.of(context).size.width * 0.7,
                                        margin: EdgeInsets.symmetric(horizontal: 35.0),
                                        height: 7,  // 원하는 높이를 설정합니다.
                                        decoration: BoxDecoration(
                                          boxShadow: [
                                            BoxShadow(
                                              color: Colors.black.withOpacity(0.3), // 검정색 그림자의 투명도 설정
                                              spreadRadius: 0.5,  // 그림자의 확산 범위 설정
                                              blurRadius: 9,      // 그림자의 흐림 정도 설정
                                              offset: Offset(0, 3),   // 그림자의 위치 오프셋 설정의 그림자의 위치 오프셋 설정
                                            ),
                                          ],
                                        ),
                                      ),                                  ],
